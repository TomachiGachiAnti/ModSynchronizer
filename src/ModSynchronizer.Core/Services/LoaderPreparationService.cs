...
public sealed class LoaderPreparationService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var tempDirectory = Path.Combine(Path.GetTempPath(), "ModSynchronizer");
    ...
    private async Task<string> DownloadTemporaryJavaRuntimeAsync(CancellationToken cancellationToken)
    {
        ...
        var tempRoot = Path.Combine(Path.GetTempPath(), "ModSynchronizer", "temp-java", Guid.NewGuid().ToString("N"));
